...
export default function NavBar(){
    ...
    useEffect(() => {
        //true once were more than 20px down the page
        const handleScroll = () => setScrolled(window.scrollY > 20);
    ...
    return (
        ...
        >
            <div className = "mx-auto flex w-full max-w7xl items-center justify-between px-4 py-3 md:px-8">
                ...
                >
                    ...
                    />
                    {/* ...middle fades out so the X has two strokes... */}
                    <span
                        className={`block h-0.5 w-6 bg-black transition-all duration-300 ${
                            menuOpen ? "opacity-0" : "opacity-100"
                        }`}
                    />
                    {/* ...bottom rotates up the other way, crossing the top */}
                    <span
                        className={`block h-0.5 w-6 bg-black transition-all duration-300 ${
                            menuOpen ? "-translate-y-2 -rotate-45" : ""
                        }`}
            ...
            <AnimatePresence>
                {menuOpen && (
                    <motion.div
                        ...
                        animate={{heght: "auto", opacity: 1}}
                        exit={{heigght: 0, opacity: 0}}
