...
// animation states for wach individual word
const wordVariant = {
    hidden: {opacity: 0, y: 60, rotateX: -40}, //starting date
    visible: { 
        opacity: 1,
        y: 0,
        rotateX: 0,
...
//main compnent --> export default ( one per page inside file )
export default function HeroSection(){

    const {scrollY} = useScroll();

    // scroll-linked values for hero image:
    // scroll it shrinks, fade out, and drifts down
    ...
    return (
        //this is a fragment - groups elements without a extra wrapper tag
        <>
        {/* text content */}
        ...
        {/* headline.variants + inital/animate tie to the states about
        ...
        >
            ...
            in small batches and shipped to your door within 48 hrs.
        </motion.p>
