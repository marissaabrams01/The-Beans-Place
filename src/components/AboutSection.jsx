...
//data for the three "what makes us diffrent" cards - written once here,
            ...
            <div className="about-story-grid">
                ...
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    <p className="about-body lead--light">
                        ...
                        be accesssible to everyone-not just aficionados. We work directly with
                        farming cooperatives across four continents, paying abouve fair-trade prices
                    ...
                    <p className="about-body lead--light">
                        ...
                        Yiargacheffe or a deep, choclatey Columbian Supremo, we roast each batch to 
